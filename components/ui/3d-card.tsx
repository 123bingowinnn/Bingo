...
export interface InteractiveTravelCardProps {
  ...
  imageUrl: string;
  /** Image sizes attribute passed through to Next.js Image (defaults to a sensible value). */
  imageSizes?: string;
  /** Mark the image as priority so Next.js eagerly loads + skips lazy. */
  priority?: boolean;
  ...
  (
    {
      ...
      subtitle,
      imageUrl,
      imageSizes = "(max-width: 768px) 88vw, 320px",
      priority = false,
      actionText,
      href,
      onActionClick,
    ...
    return (
      ...
      >
        ...
        >
          {/* Background Image — Next.js Image for proper DPR + srcset (no GPU blur on retina). */}
